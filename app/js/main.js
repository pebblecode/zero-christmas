...
(function (){
  'use strict';  
    ...
    // change all background colours in range to #202836
    $( '*' ).filter( function() {
      var match1 = [ 70, 160 ];
      var match2 = [ 0, 30 ];
      var match3 = [ 330, 360 ];
      ...
      $( this ).css( 'background-color' , '#202836');
    } );

    // change all background text in range to #202836
    $( '*' ).filter( function() {
      var match1 = [ 70, 160 ];
      var match2 = [ 0, 30 ];
      var match3 = [ 330, 360 ];
